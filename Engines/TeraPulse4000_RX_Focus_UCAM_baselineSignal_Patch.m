...
%
% temp version explanation: extract baseline signal from 
%   the first imported file and apply it to the rest files.
%   please bear in mind that the first file is only referred to the
%   baseline signal
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function Tcell = TeraPulse4000_RX_Focus_UCAM(PRJ_count,fullpathname,DEBUGMsgLabel,uiFigure,Tcell)
            ...
            for PRJcnt = 1:PRJ_count
                ...
                if isequal(PRJcnt,1)
                    groupName = HDFDataInfo.Groups(1).Name;
